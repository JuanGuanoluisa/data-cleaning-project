...
DataCrud <- rbind(subjectTrain, subjectTest)
...
# label DataCrud
names(DataCrud) <- "subjectnumber"

# Then: Time to merge everthing together and save into a file: XData, YData, DataCrud
# I write the out put to a file.txt

merged <- cbind(DataCrud, YData, XData)
